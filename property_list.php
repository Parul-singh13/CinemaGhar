...
<head>
    ...
    <title>Best Cinemas in Mumbai | CinemaGhar</title>
        ...
        ?>
              ...
              <div class="property-card row">
                  <div class="image-container col-md-4">
                      <img src="img/properties/1/Liberty.jpg" />
                  </div>
        ...
        <?php
          ...
          elseif( mysqli_num_rows($properties_result)==0 )
          {
            ...
            <div class="no-pg mx-4 my-5">
              <h2>Currently, there are no Cinemas in <?php echo $city; ?> listed on our Platform, but soon there will be!</h2>
              <hr>
              <p>
                Try searching for Cinemas in some other nearby cities for now. Our network is growing day-by-day and soon we will come up with Cinemas listed in more cities nationwide.
              </p>
              <br>
              <p>
                Soon, we will have registered Cinemas at <?php echo $city; ?>.
              </p>
            </div>
            <?php
          }
