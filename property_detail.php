...
if( $con )
{
  ...
  elseif( mysqli_num_rows($property_result)==1 )   
  {
    ...
    $sql_interest = "SELECT * FROM interested_users_cinema WHERE property_id = $pg_id; ";
...
<head>
    ...
    <title>Ganpati Paying Guest | Apna PG</title>
...
<?php
// Details of property when correct single cinema is fetched from database
    ...
    <div id="property-images" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
          <div class="carousel-item active">
              <img class="d-block w-100" src="img/properties/1/Liberty.jpg" alt="slide">
          </div>
          <div class="carousel-item ">
              <img class="d-block w-100" src="img/properties/1/delite2.jpg" alt="slide">
          </div>
          <div class="carousel-item">
              <img class="d-block w-100" src="img/properties/1/red.jpg" alt="slide">
          </div>
      </div>
    ...
    <div class="property-summary page-container">
      ...
      <div class="row no-gutters">
          ...
          <div class="button-container col-6">
              <a href="final_pro\index.html" class="btn btn-primary">Book Now</a>
          </div>
      </div>
    </div>
    ...
    ?>
          <div class="testimonial-block">
              <div class="testimonial-image-container">
                  <img class="testimonial-img" src="mant.jpg">
              </div>
