...
<head>
    ...
    <link href="css/common.css" rel="st
...
<body>
  ...
  <div class="container-fluid pg-search-container">
    <div class="row justify-content-center mb-3 text-black">
      <div class="col-auto">
        <h2><b>&nbsp Your Gateway to Entertainment</b></h2>
      </div>
    </div>
    <!-- Search Bar -->
      ...
      <div class="row justify-content-center">
        <div class="col-md-6 col-sm-8">
          <div class="input-group md-form form-sm form-2 pl-0">
            <input name="city" class="form-control my-0 py-1 red-border" type="text" placeholder="Enter your city to search for Cinemas" aria-label="Search">
